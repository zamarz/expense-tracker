...
export default function ExpenseAdder({ navigation }) {
  ...
  const [categoryAdderVisible, setCategoryAdderVisible] = useState(false);
      ...
      {({ handleChange, handleBlur, handleSubmit, values, errors }) => {
        return (
          <View style={styles.container}>
            ...
            <CategoryAdderModal
              isVisible={categoryAdderVisible}
              setIsVisible={setCategoryAdderVisible}
            />
            <TextInput
              aria-label="Account"
              placeholder="Account"
